...
Sub Limpar_Filtro()
    If Sheet5.FilterMode = True Then
        Define_Celulas
...
Sub Filtro_Status(Filtro As String)
    ...
    Range("B8:K62").AdvancedFilter Action:=xlFilterInPlace, CriteriaRange:=Range("Q3:Q4"), Unique:=False
    'Onde :
    'Range("B8:K62").AdvancedFilter Action:=xlFilterInPlace = Linhas a serem filtradas
    'CriteriaRange:=Range("Q3:Q4") = Celulas que contêm os filtros, sendo a Q3 o título, e Q4 o conteúdo a ser filtrado. O título na Q3 deve estar escrito exatamente igual ao título na Range("B8:K62"), se tiver espaço a esquerda ou direita do conteúdo, deve estar assim no filtro também.
End Sub
